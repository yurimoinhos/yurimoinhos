...
Olá, meu nome é Yuri! Sou um desenvolvedor apaixonado por tecnologia. Com raízes sólidas em desenvolvimento Java, Vue.js e Docker, me torno uma opção flexível para qualquer tipo de projeto.

## 🎓 Formação

- **Estudante de Ciência de Dados e Inteligência Artificial** - SENAI CIMATEC
...
![Microsserviços](https://img.shields.io/badge/-Microsserviços-FF6F00?style=for-the-badge&logo=microservices&logoColor=white)
